...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    public boolean isKongBai = true;//false的时候，点击空白处不收对话框

    public boolean isBackKey = true;//false的时候，点击返回键处不收对话框
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_top.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (NetStatus.getNetStatus(context)&&isKongBai){
                    if (cancel) {
                        dismiss();
                    }
                }
    ...
    public void onBackPressed() {
        ...
        if (NetStatus.getNetStatus(context)&&isBackKey){
            super.onBackPressed();
        }
    }
