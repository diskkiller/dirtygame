...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    private  int btn_hight,title_hight = 45;
    ...
    public View onCreateView() {
        ...
        /** content */
        rl_content.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams
                .MATCH_PARENT,
                RelativeLayout.LayoutParams.WRAP_CONTENT));
        rl_content.setGravity(Gravity.CENTER);
        ll_container.addView(rl_content);


        /** btns */
        if(btnNum != 0){
            v_line_horizontal = new View(context);
            v_line_horizontal.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams
                    .MATCH_PARENT, 1));
            ll_container.addView(v_line_horizontal);

            tv_btn_left.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(btn_hight), 1));
            ...
            tv_btn_middle.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(btn_hight), 1));
            ...
            tv_btn_right.setLayoutParams(new LinearLayout.LayoutParams(0, dp2px(btn_hight), 1));
    ...
    public void setBtnHight(int hight){
        this.btn_hight = hight;
    }
    public void setTitleHight(int hight){
    ...
    public void setUiBeforShow() {
        ...
        /** title */
        if (style == STYLE_ONE) {
            tv_title.setMinHeight(dp2px(45));
            tv_title.setGravity(Gravity.CENTER);
            tv_title.setPadding(dp2px(0), dp2px(5), dp2px(0), dp2px(5));
