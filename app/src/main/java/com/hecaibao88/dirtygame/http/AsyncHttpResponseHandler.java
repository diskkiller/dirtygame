...
public  class AsyncHttpResponseHandler {
    ...
    void sendResponseMessage(HttpResponse response) {
        Log.i("ent_net_response", "" + response.toString());
        StatusLine status = response.getStatusLine();
        String responseBody = null;
        try {
            HttpEntity entity = null;
            HttpEntity temp = response.getEntity();
//            Log.i("ent_net_response", "entity = " + temp );
            if(temp != null) {
                entity = new BufferedHttpEntity(temp);
                responseBody = EntityUtils.toString(entity, "UTF-8");
//                Log.i("ent_net_response", "responseBody = " + responseBody );
            }
        } catch(Exception e) {
//            Log.i("ent_net_response", "IOException responseBody e = " + e.getMessage());
            sendFailureMessage(e, (String) null);
        }
//        Log.i("ent_net_response", "status.getStatusCode() = " + status.getStatusCode());
//        Log.i("ent_net_response", "responseBody = " + responseBody );
